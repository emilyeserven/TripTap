 ...
 */
export interface StoredMigakuCandidate extends MigakuCandidate {
...
/** Project a stored candidate to its public wire shape (drops internal media filenames). */
export function toPublicCandidate(stored: StoredMigakuCandidate): MigakuCandidate {
  return {
    id: stored.id,
    kind: stored.kind,
    text: stored.text,

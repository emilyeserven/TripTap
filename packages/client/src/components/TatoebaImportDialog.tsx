...
/**
 * Build a create input from a Tatoeba result. The CC-BY 2.0 FR licence requires attribution, so the
 ...
 */
function toInput(example: ExampleSentence): CreateSentenceInput {
 ...
 *
 * **The bank is the only kind offered here, deliberately.** A Tatoeba sentence is a licensed
 * reference example, not something the learner wrote or is drilling; keeping it bank-kind keeps the
 * attribution visible where reference material lives. Other providers (Renshuu) have no such
 * constraint and offer all three.
 */
